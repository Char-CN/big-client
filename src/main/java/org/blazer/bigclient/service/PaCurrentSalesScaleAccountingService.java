 ...
 */
@Service
public class PaCurrentSalesScaleAccountingService extends BaseService<PaCurrentSalesScaleAccounting> {

    private static final Logger LOGGER = LoggerFactory.getLogger(PaCurrentSalesScaleAccountingService.class);

    public PageInfo<PaCurrentSalesScaleAccounting> findByPage(HashMap<String, String> params) {
        LOGGER.info("根据条件分页查询：活期销售规模核算<PaCurrentSalesScaleAccounting>列表...");
...
//        }
    ...
    public List<PaCurrentSalesScaleAccounting> findBySearch(String search) {
        LOGGER.info("根据条件查询：活期销售规模核算<PaCurrentSalesScaleAccounting>，导出到excel表...");
        Example example = new Example(PaCurrentSalesScaleAccounting.class);
        Example.Criteria criteria = example.createCriteria();
